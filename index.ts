...
//
function getRelativePosition(element: HTMLElement, container: HTMLElement): { x: number; y: number } {
...
export class Particle {
  ...
  //--
  obj?:IPositionObject;
  public bindToObject(o:IPositionObject){
    this.obj=
  }
  public bindToElement(ele:HTMLElement,cont:HTMLElement){

  }

  public static createByElement(cont:HTMLElement,ele:HTMLElement)
  {
...
export class PhysicsEngine {
  particles: Particle[] = [];
  repulsionConstant: number = 1000; // 斥力常数，调整强度
  minDistance: number = 10; // 最小距离，避免除零或过大斥力
  ...
  onUpdated=new Subject<PhysicsEngine>();
  startSim() {
    // 模拟循环
